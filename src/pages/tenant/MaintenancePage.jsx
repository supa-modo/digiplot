...
import { 
  TbTools, TbPlus, TbLoader2, TbX, TbChevronRight, TbFilter, 
  TbArrowUp, TbArrowDown, TbSearch, TbEye, TbMessage, 
  TbCalendarTime, TbBell, TbRefresh, TbClipboardCheck,
  TbClipboardList, TbClipboardX, TbAlertTriangle, TbInfoCircle,
  TbAdjustments, TbCalendarEvent, TbSun, TbBuildingSkyscraper
} from 'react-icons/tb';
...
const MaintenancePage = () => {
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      setError('Failed to refresh maintenance requests. Please try again later.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="pt-6 pb-10 mx-auto max-w-screen-2xl px-2 md:px-4">
      ...
      {/* Stats Cards */}
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6 px-4">
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div className="flex-1 min-w-0">
                    ...
                    <h3 className="text-base font-medium text-gray-900 truncate">{request.title}</h3>
                    <div className="mt-1 flex items-center text-sm text-gray-500">
                      ...
                      {request.updates && request.updates.length > 0 && (
                        <>
                          ...
                          <span>{request.updates.length} update{request.updates.length !== 1 ? 's' : ''}</span>
                        </>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="mt-2 md:mt-0 flex items-center">
                    ...
                    >
                      <TbEye className="mr-1.5 h-4 w-4 text-gray-500" />
                      View Details
                    </button>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          ...
          >
            ...
            <div className="sticky top-0 z-20 flex items-center justify-between rounded-t-2xl bg-gradient-to-r from-secondary-plot to-primary-plot p-5 text-white">
              <h3 className="text-xl font-bold">Maintenance Request Details</h3>
              <button 
