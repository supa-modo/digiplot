...
const Notification = ({ 
  ...
  // Determine the color scheme based on the notification type
  const getTypeStyles = () => {
    switch (type) {
      case 'success':
        return {
  ...
  return (
    <div className={`fixed right-4 top-4 z-50 max-w-md overflow-hidden rounded-lg border-l-4 shadow-md ${styles.container}`}>
